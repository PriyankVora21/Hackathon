...
<img src="book.jpg" style="height:100%;width:100%;position:fixed;opacity:0.6;top:0%;left:0%"/>
<button onclick="document.getElementById('id01').style.display='block'" style="width:180px;height:60px;position:absolute;top:75%;left:45%;background-color:blue">Login</button>
...
<button onclick="document.getElementById('id02').style.display='block'" style="width:180px;height:60px;position:absolute;top:85%;left:45%;background-color:blue">Signup</button>
...
<div id="id02" class="modal">
  ...
  <form class="modal-content animate" action="<%=request.getContextPath() %>/RegController" method="post"  >
    <span onclick="document.getElementById('id02').style.display='none'" class="close" title="Close Modal">&times;</span>
      ...
      <input type="text" placeholder="password" name="pass_sign" required>
